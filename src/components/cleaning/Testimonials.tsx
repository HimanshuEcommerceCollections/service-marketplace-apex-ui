// section: TESTIMONIALS — expanding filmstrip + quote panel. The carousel logic
// (active card, autoplay, progress bar, arrows, dots, keyboard) is in the runtime;
// this renders the initial DOM with card 3 (Aisha) active, matching the source.
