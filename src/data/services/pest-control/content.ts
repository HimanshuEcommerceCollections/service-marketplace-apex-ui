...
export const content: ServiceConfig = {
  ...
  recurring: {
    ...
    plans: [
      { name: 'One-time', freq: 'Single visit', amount: '$99' },
      { name: 'Weekly', freq: 'Every week', amount: '$99', unit: '/visit', disc: 'Save 15%', best: true },
      { name: 'Biweekly', freq: 'Every 2 weeks', amount: '$99', unit: '/visit', disc: 'Save 10%' },
    ],
  },
  finalCta: {
