...
export const content: ServiceConfig = {
  ...
  recurring: {
    ...
    plans: [
      { name: 'One-time', freq: 'Single visit', amount: '$349' },
      { name: 'Weekly', freq: 'Every week', amount: '$349', unit: '/visit', disc: 'Save 15%', best: true },
      { name: 'Biweekly', freq: 'Every 2 weeks', amount: '$349', unit: '/visit', disc: 'Save 10%' },
    ],
  },
  finalCta: {
